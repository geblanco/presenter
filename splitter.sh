...
gs -o $slideshow_name -sDEVICE=pdfwrite -c "[/CropBox [0 0 362.835 272.126]" -c " /PAGES pdfmark" -f $file 1>/dev/null
gs -o $notes_name -sDEVICE=pdfwrite -c "[/CropBox [362.835 0 725.669 272.126]" -c " /PAGES pdfmark" -f $file 1>/dev/null
